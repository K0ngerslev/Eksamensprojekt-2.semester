...
public class AktivitetRepository : IAktivitetRepository
{
    ...
    private readonly IMongoCollection<Aktivitet> aktiviteter;
    ...
    public AktivitetRepository()
    {
        ...
        aktiviteter = database.GetCollection<Aktivitet>("Aktiviteter");
    }
    ...
    {
        await aktiviteter.InsertOneAsync(aktivitet);
    }
    ...
    public async Task UpdateAsync(string id, Aktivitet aktivitet)
    {
        ...
        aktivitet.Id = id;
        await aktiviteter.ReplaceOneAsync(existingAktivitet => existingAktivitet.Id == id, aktivitet);
    }
